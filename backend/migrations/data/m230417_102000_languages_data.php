...
class m230417_102000_languages_data extends yii\db\Migration
{
    public function safeUp()
    {
        ...
        // Source https://github.com/lipis/flag-icons/issues/510
        $countryList = json_decode(file_get_contents(__DIR__ . '/../dump/languages_to_country.json'), true);
        ...
        foreach ($googleList as $code2) {
            ...
            if (isset($countryList[strtolower($code2)])) {
                $country = $countryList[strtolower($code2)];
            } else {
                $country = '';
                echo "Unable to find country $code2 in countryList\n";
                continue;
            }
            ...
            $toInsert[] = ['code' => $code2, 'code3' => $code3, 'title' => $title, 'titleEnglish' => $titleEnglish, 'titleNative' => $titleNative, 'country' => $country];
        }
