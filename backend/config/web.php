...
$config = [
    ...
    'components' => [
        ...
        'cache' => [
            ...
            'redis' => [
                'hostname' => isset($_SERVER['REDIS_SERVICE_HOST']) ? $_SERVER['REDIS_SERVICE_HOST'] : 'localhost',
        ...
        'urlManager' => [
            ...
            'rules' => [
                [
                    ...
                    'controller' => [
                        'user', 'transaction', 'category', 'content', 'language', 'translate',
                        'plugin', 'dictionaries/lists' => 'dictionary-list', 'dictionary', 'mnemonic', 'log',
                        'content-report', 'content-attribute', 'drill',
                    ],
                    'prefix' => 'api',
                    'patterns' => [
                        'PUT,PATCH {id}' => 'update',
                ...
                'api/surprise-content' => 'content/random',
