...
@Component({
  ...
  templateUrl: './create-materials-page.component.html',
  styleUrls: ['./create-materials-page.component.scss']
})
export class CreateMaterialsPageComponent implements OnInit, OnDestroy {
