...
@Component({
  ...
  templateUrl: './edit-materials-page.component.html',
  styleUrls: ['./edit-materials-page.component.scss']
})
export class EditMaterialsPageComponent implements OnInit, OnDestroy {
  material: Content;
  errors: any[] = [];
