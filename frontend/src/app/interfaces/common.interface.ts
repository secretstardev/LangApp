...
export interface KanjiStats {
  absoluteStats?: Record<number, number>;
  absoluteTotal?: number;
  coverageStats?: Record<number, number>;
  jlptLevel?: number;
}
...
export interface UserPaymentMethodDetails {
  id: number;
  icon: IconType;
  cardNumber: string;
  expiry: string;
