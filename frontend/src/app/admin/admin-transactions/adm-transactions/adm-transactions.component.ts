...
import { availableCurrencyList } from '@app/libs/config/availableCurrencyList';
...
export class AdmTransactionsComponent implements OnInit, OnDestroy {
  ...
  constructor(public session: SessionService, private adapter: DateAdapter<any>, private api: ApiService, private eventService: EventService, private ref: ChangeDetectorRef, private router: Router, private route: ActivatedRoute, private translate: TranslateService) {}
  ...
  getTransactions(): void {
    ...
    this.transactionsSubscription = this.api
      .getTransactions(this.paginator.page, filterValue, sort)
  ...
  translatePage() {
    ...
    this.translate
      .get(Object.keys(this.translatedKeys))
      .pipe(untilDestroyed(this))
      .subscribe((res: any) => {
