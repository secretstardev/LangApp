...
import { APP_NAME } from '@app/libs/config/config';
    ...
    let menuItems: MenuItem[] = [
      ...
      },
      {
        ...
        items: [
          ...
          {
            label: 'Home',
            routerLink: [routingConfig.home.fullPath],
            icon: 'home',
          },
          {
            label: 'Study',
          ...
          // {
          //   label: 'Words2',
          //   routerLink: [routingConfig.dictionaryList.fullPath],
          //   icon: 'c-icons icon-wordlist',
          // },
          // {
          //   label: 'Study2',
          //   routerLink: [routingConfig.training2.fullPath],
          //   icon: 'c-icons icon-study',
          // },
        ],
      },
    ...
    let menuItems: MenuItem[] = [
      {
        ...
        items: [
          {
            label: 'Settings',
            routerLink: [routingConfig.settings.fullPath],
            icon: 'setting',
            visible: this.isLoggedIn,
          },
          {
